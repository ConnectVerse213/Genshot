    ...
    !function(e, t) {
      ...
      var e = { 292: function(e2, t2) {
        ...
        t2.classToClassList = (e3, t3, o3 = " ", i2 = "add") => {
          e3.split(o3).forEach((e4) => {
            e4.trim() && ("add" === i2 ? t3.classList.add(e4) : t3.classList.remove(e4));
          });
        };
        ...
        class l extends s.default {
          ...
          static treeView() {
            ...
            this.selectable = [], document.querySelectorAll(".hs-accordion-treeview-root").forEach((e3) => {
              const t3 = null == e3 ? void 0 : e3.getAttribute("data-hs-accordion-options"), o3 = t3 ? JSON.parse(t3) : {};
...
@preline/accordion/index.js:
   ...
   *)
*/
//# sourceMappingURL=@preline_accordion.js.map
